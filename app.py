...
# Config MySQL
mysql = MySQL()
app.config['MYSQL_HOST'] = os.getenv('MYSQL_ROOT_HOST', 'localhost')
app.config['MYSQL_USER'] = os.getenv('MYSQL_ROOT_USER', 'root')
app.config['MYSQL_PASSWORD'] = os.getenv('MYSQL_ROOT_PASSWORD', 'root')
app.config['MYSQL_DB'] = os.getenv('MYSQL_ROOT_DB', 'ecommerce')
app.config['MYSQL_PORT'] = os.getenv('MYSQL_ROOT_PORT', '3306')
...
if __name__ == '__main__':
    app.run(host="0.0.0.0", port=int(FLASK_APP_PORT),debug=True)
